...
//extends UsernamePasswordAuthenticationFilter 를 상속한
//오버라이드 메서드   attemptAuthentication 속의 authenticate(Authentication authentication) 를 호출해
//의해 실행되는 클래스 
...
//	AdminAuth adminAuth;
	...
	//	System.out.println("씨발:   "+authentication.toString());
